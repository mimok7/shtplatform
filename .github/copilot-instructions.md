...
- Colons are fine inside code, key-value pairs, timestamps, or labels. Not as sentence enders.
...
This is the step coding agents skip most often after "run tests". They guess from error keywords and apply the most-recent-pattern fix. That's how a one-line bug becomes a three-file refactor.
