...
function HotelReservationContent() {
    ...
    // 사용 가능한 호텔 서비스 로드 (hotel_price 테이블에서 조회)
    ...
    const handleSubmit = async () => {
        ...
        if (!form.serviceData.room_count || Number(form.serviceData.room_count) < 1) {
            alert('객실 수를 1 이상 입력해주세요.');
            return;
        }
        ...
        try {
            ...
            if (availableServices.length > 0) {
                ...
                const hotelData = {
                    ...
                    total_price: mainHotel.base_price || 0,
    ...
    return (
        <PageWrapper>
            <div className="space-y-6">
                ...
                <SectionBox title="사용 가능한 호텔 서비스">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleInputChange('room_count', e.target.value === '' ? '' : parseInt(e.target.value))}
                                            className="w-full px-3 py-2 border border-gray-300 rounded-md"
                                        />
                                    </div>
                                    <div>
