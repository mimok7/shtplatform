                      ...
                      <div key={index} className="border border-gray-200 rounded-lg p-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            {(rentcar.rentcarInfo?.return_datetime || rentcar.rentcarInfo?.return_pickup_location || rentcar.rentcarInfo?.return_destination || rentcar.rentcarInfo?.dropoff_location) && (
                              <>
                                <p className="text-sm text-gray-600">리턴일시: {rentcar.rentcarInfo?.return_datetime || '-'}</p>
                                <p className="text-sm text-gray-600">리턴위치: {rentcar.rentcarInfo?.return_pickup_location || rentcar.rentcarInfo?.dropoff_location || '-'}</p>
                                <p className="text-sm text-gray-600">리턴목적지: {rentcar.rentcarInfo?.return_destination || '-'}</p>
                              </>
                            )}
                          </div>
                          <div>
