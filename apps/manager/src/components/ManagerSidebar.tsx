...
export default function ManagerSidebar({ activeTab, userEmail, onLogout, userRole, onClose }: ManagerSidebarProps) {
    ...
    const derivedTab = (() => {
        ...
        if (pathname.startsWith('/manager/packages')) return 'packages';
                        ...
                        <div className="grid grid-cols-1 gap-2">
                            ...
                            >
                                ...
                                <NavItem
                                    ...
                                    isActive={isActiveTab('packages')}
                                    onClick={() => handleNavigation('/manager/packages')}
                                />
                                <NavItem
                                    icon="💱"
                                    label="환율 관리"
