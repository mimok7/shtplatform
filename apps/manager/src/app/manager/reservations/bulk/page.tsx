...
const quoteItemName = (item: any) => item?.serviceType === 'airport' && item?.metadata?.airportRoute ? item.metadata.airportRoute : item?.name || '상품 정보';
