                    ...
                    <>
                        ...
                        <div className="bg-white rounded-lg border p-4 space-y-3">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        ...
                                        className="px-3 py-2 rounded bg-teal-600 text-white text-sm disabled:bg-gray-300"
                                    >
                                        {copiedBody ? '내용 복사 완료' : '내용 복사'}
                                    </button>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    value={generatedBody || generatedHeader}
                                    readOnly
                                    className="w-full min-h-[420px] border rounded-lg px-3 py-2 text-sm whitespace-pre-wrap"
                                    placeholder="서비스 버튼을 눌러 안내문을 생성해 주세요."
                                />
                            </div>
                        </div>
                    </>
